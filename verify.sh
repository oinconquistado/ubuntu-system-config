...
test_flatpak_apps() {
    ...
    if command -v flatpak &> /dev/null; then
        ...
        local apps=("org.wezfurlong.wezterm:WezTerm" "com.vivaldi.Vivaldi:Vivaldi" "com.bitwarden.desktop:Bitwarden" "io.github.sigmasd.stimulator:Stimulator")
...
generate_report() {
    ...
    log_msg "Total: $TESTS_TOTAL | Passed: $TESTS_PASSED | Failed: $TESTS_FAILED | Skipped: $TESTS_SKIPPED"
